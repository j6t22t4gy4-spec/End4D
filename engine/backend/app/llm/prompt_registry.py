...
PROMPT_SPECS: dict[str, PromptSpec] = {
    ...
    "session_review_query": PromptSpec(
        ...
        version="session-review-query-v3",
        output_mode="json",
