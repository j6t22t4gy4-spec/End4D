...
**핵심 코어는 엔진.** 시간축을 가진 2D 사회장 + social elevation(z) 시뮬레이션 런타임이 중심이다.
...
│  [Organic4D 엔진 — 핵심 코어]                                    │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────────────────┐  │
│  │ 2D 사회장   │  │ 5대 규칙    │  │ 시간 흐름 + social z + 3계층 감정·생각 │  │
...
- 시각화용 `(x,y,z)`, `zone`, `energy`, `emotion_vec`, `thought_vec`, `worldview_vec` 등 프리미티브
...
│  + Map UI                2D 사회장 + social z + 시간 루프 + 5대 규칙 │
├─────────────────────────────────────────────────────────────────┤
│  [Storage]           [Memory]         [LLM]                      │
